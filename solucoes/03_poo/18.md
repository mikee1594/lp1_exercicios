...
Tipos imutáveis criam sempre cópias dos tipos de valor, ou seja, garante-nos que, 
quando passamos uma String, (por exemplo) como parametro para um método, 
o conteúdo da mesma não sofrerá alterações após ser invocada.
