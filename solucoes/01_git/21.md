...
O erro que dá, deve-se ao nosso repositório local ter falta de um ou mais ficheiros face ao ao repositório remoto. Para resolução deste problema, é necessário descarregar as novidades do repositório upstream e junta-las ao ramo master. Por fim adicionar as alterações com o respectivo commit.
...
$ git add .
$ git commit -m "mensagem apropriada"
